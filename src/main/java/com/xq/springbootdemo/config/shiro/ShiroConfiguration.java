...
public class ShiroConfiguration {
     ...
     * @return
     ...
     对称加密：同一个密钥可以加密和解密，DES,二重DES等等
     非对称加密：用于数字签名，数字证书。有两种钥匙，分别是私钥和公钥，公钥加密，私钥解密。RSA,DSA
     摘要算法（散列算法）：单向加密算法MD5,SHA1,SHA2,加盐
     不加盐：明文abcd->xxx    还原xxx->abcd
     加盐：盐degf  明文：abcd+盐=abedgfcd>xxxx   还原：xxxx->abedgfcd
     }
     */
}
